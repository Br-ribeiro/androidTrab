...
public class AdapterJaponesa extends RecyclerView.Adapter<AdapterJaponesa.ViewHolder>{
    ...
    private static final String TAG = AdapterJaponesa.class.getSimpleName();


    int img[] = {R.drawable.imgtest, R.drawable.imgtest, R.drawable.imgtest, R.drawable.imgtest, R.drawable.imgtest, R.drawable.imgtest, R.drawable.imgtest, R.drawable.imgtest, R.drawable.imgtest, R.drawable.imgtest};
